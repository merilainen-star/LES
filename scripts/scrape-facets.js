...
//
// Usage:
//   node scripts/scrape-facets.js
//
// Requires Node 18+ (for built-in fetch). A local Node binary is shipped
// in the ignored tools/ folder (tools/node.exe on Windows) — use it if
// system Node isn't available.
